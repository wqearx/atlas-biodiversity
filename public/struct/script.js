...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const animalDetails = {
    ...
    "Лиса": "Научное название: Vulpes vulpes - хищник семейства псовых. Известна своей хитростью и умением приспосабливаться к различным условиям обитания.",
    ...
    "Орел": "Научное название: Aquila chrysaetos - крупная хищная птица. Обитает в горах и лесах, охотится на мелких и средних млекопитающих, обладает острым зрением и сильными когтями.",
    ...
    "Колибри": "Научное название: Trochilidae - маленькая птица, зависающая в воздухе. Питается нектаром цветов, активно участвует в опылении.",
